...
namespace RdkShell
{
    ...
    void CompositorController::onKeyPress(uint32_t keycode, uint32_t flags, uint64_t metadata, bool easterEggsProcessingEnabled)
    {
        //std::cout << "key press code " << keycode << " flags " << flags << std::endl;
        double currentTime = RdkShell::seconds();
        if ((true == easterEggsProcessingEnabled) && (0.0 == gLastKeyPressStartTime))
        {
    ...
    void CompositorController::onKeyRelease(uint32_t keycode, uint32_t flags, uint64_t metadata, bool easterEggsProcessingEnabled)
    {
        //std::cout << "key release code " << keycode << " flags " << flags << std::endl;
        if (true == easterEggsProcessingEnabled)
        {
