...
namespace RdkShell
{
  ...
  void ServerMessageHandler::initMsgHandlers()
  {
  ...
  {
    CompositorController::setEventListener(getptr());
    mCommunicationHandler->initialize();
  }

  void ServerMessageHandler::poll()
  {
    mCommunicationHandler->poll();
  }
  ...
  void ServerMessageHandler::messageReceived(int id, std::string& request)
  {
    Document d;
  ...
  bool getBoundsHandler(int id, const rapidjson::Value& params, void* context)
  {
    ...
    if (NULL != context)
    {
      ((ServerMessageHandler*)context)->getCommunicationHandler()->sendMessage(id,message);
    }
  }
  ...
  void ServerMessageHandler::onAnimation(std::vector<std::map<std::string, RdkShellData>>& animationData)
  {
    ...
    std::string message(response.str());
    if (mCommunicationHandler)
      mCommunicationHandler->broadcast(message);
  }

  CommunicationHandler* ServerMessageHandler::getCommunicationHandler()
  {
    return mCommunicationHandler;
  }

  std::shared_ptr<ServerMessageHandler> ServerMessageHandler::getptr()
  {
  ...
  void ServerMessageHandler::process()
  {
    ...
    //loop for message queue and take data
  } */
}
