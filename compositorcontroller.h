...
namespace RdkShell
{
    class CompositorController
    {
        public:
            ...
            static void onKeyPress(uint32_t keycode, uint32_t flags, uint64_t metadata, bool easterEggsProcessingEnabled=true);
            static void onKeyRelease(uint32_t keycode, uint32_t flags, uint64_t metadata, bool easterEggsProcessingEnabled=true);
